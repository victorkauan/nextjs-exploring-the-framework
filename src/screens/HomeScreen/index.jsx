...
const ALURA_LOGO_URL = "/images/alura-logo.svg";
      ...
      >
        ...
        >
          <Image
            ...
            src={SIDE_IMAGE_URL}
            alt="Training with Roberta Arcoverde at Alura Cases, talking about Stack Overflow."
          />
        </Box>
      </Box>
    </Box>
...
export default function HomeScreen() {
  return (
    <Box>
      <PageTitle>Home - Alura Cases Campaign</PageTitle>
      <Box
        as="main"
        styleSheet={{
          flex: 1,
              ...
              >
                <Box>
                  ...
                  >
                    ...
                    >
                      <Text>Check the main questions</Text>
                      <Icon
                        styleSheet={{
                ...
                >
                  ...
                  >
                    Here you will have access to advanced discussions: the main
                    decisions about system architecture and design. Learn
                    through the breakthroughs facing top tech companies!
                  </Text>
                  <Text
                    as="p"
                    styleSheet={{
                  ...
                  >
                    Want to test it before everyone else?
                  </Text>
                </Box>
                <Box
                  as="form"
